...
public class TicketAdapter extends RecyclerView.Adapter<TicketAdapter.TicketViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TicketViewHolder holder, int position) {
        ...
        holder.tvTime.setText(holder.itemView.getContext().getString(R.string.status_time_bullet, ticket.getTime()));
        ...
        } else if (ticket.getStatus().equalsIgnoreCase("Resolved")) {
        ...
        } else if (ticket.getPriority().equalsIgnoreCase("Low")) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("subject", ticket.getSubject());
                intent.putExtra("status", ticket.getStatus());
                intent.putExtra("priority", ticket.getPriority());
